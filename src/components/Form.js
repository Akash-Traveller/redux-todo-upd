...
import { addTodo, handleEditSubmit } from '../redux/todofunct/actions/actions';

const Form = ({editFormVisiblelity , editTodo , cancelUpdate}) => {
  ...
  const editSubmit = (e) => {
    ...
    dispatch(handleEditSubmit(editedValue));
  }
